                    ...
                    <table width="660" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                        <tr>
                            <td valign="middle" style="padding: 20px 35px;">
                                <h3>Se ha recibido una solicitud para habilitar un perfil comercial con los siguientes datos.</h3>

                                <p>ID de solicitud: {{$data->id}}</p>
                                <p>Razon Social: {{$data->rsocial}}</p>
                                <p>Cuit: {{$data->cuit}}</p>
                                <p>Email: {{$data->email}}</p>

                                <br>
                                <p>Los demas datos y para proceder a su habilitacion revisarlo desde el administrador.</p>
