    ...
    <div class="container py-6">
        <div class="row gy-5 justify-content-center">
            <div class="col-12 text-center col-md-6 col-lg-3">
                <figure>
                    <img style="width: 64px;" src="/storage/{{Voyager::setting('site.lf')}}" alt="" class="img-fluid">
                </figure>
...
<a href="#" id="back-to-top" class="btn btn-primary back-to-top"><i class="fas fa-angle-up"></i></a>