                                ...
                                <select id="m_category" class="form-control" name="url">
                                   ...
                                   @foreach($category as $cat):
                                    ...
                                    @if(!is_null($cat->parent_id)):
                                        <option value="/categoria/{{ $cat->id }}/{{str_slug($cat->name, '-')}}" > subcategoria / {{ $cat->name }}</option>    
                                    
                                    @elseif(is_null($cat->parent_id)):   
                                        <option value="/categoria/{{ $cat->id }}/{{str_slug($cat->name, '-')}}" >{{ $cat->name }}</option>   
                                    @endif 
