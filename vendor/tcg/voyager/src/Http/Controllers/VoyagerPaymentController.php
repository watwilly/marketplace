...
class VoyagerPaymentController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $comprador =    $dataTypeContent->compradorId()->first();
        $vendedor =     $dataTypeContent->vendedorId()->first();
        $details =      $dataTypeContent->detailsId()->first();
        $item =         $dataTypeContent->comprasId()->first();
        $intentos =     $dataTypeContent->intentosId()->get();
        ...
        return Voyager::view($view, compact('dataType','details','item','intentos','comprador', 'vendedor', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
