...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('Notificacion de cambio de contraseña'))
            ...
            ->action(Lang::get('Modificar contraseña'), $url)
            ->line(Lang::get('Este lin expira :count minutes.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
