                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <select id="m_link_type" class="form-control" name="type">
                            ...
                            <option value="post">Notas</option>
                        ...
                        <div id="m_pagina_type">
                            <label for="pagina" style="color: black;">Seleccione Pagina </label>
                            <select id="m_pagina" class="form-control" name="url">
                                 <option value="/contratar/servicios">Servicios</option>
                                 <option value="/contacto">Contacto</option>
                                 <option value="/buenos-precios">Buenos precios</option>
                                 <option value="/ventas/comercios/tiendas">Comercios & Tiendas</option>
                            </select>   
                        </div>

                        <div id="m_category_type">

                            <label for="category" style="color: black;">Seleccione Categoria</label>
                                <select id="m_category" class="form-control" name="url">
                                   
                                   <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:

                                    <?php if(!is_null($cat->parent_id)): ?>:
                                        <option value="/categoria/<?php echo e($cat->id); ?>/<?php echo e(str_slug($cat->name, '-')); ?>" > subcategoria / <?php echo e($cat->name); ?></option>    
                                    
                                    <?php elseif(is_null($cat->parent_id)): ?>:   
                                        <option value="/categoria/<?php echo e($cat->id); ?>/<?php echo e(str_slug($cat->name, '-')); ?>" ><?php echo e($cat->name); ?></option>   
                                    <?php endif; ?> 
    ...
    <script>
        $(document).ready(function () {
            ...
            var $m_modal       = $('#menu_item_modal'),
                ...
                $m_category_type        = $('#m_category_type'),
                $m_category           = $('#m_category'),
               
                $m_pagina_type        = $('#m_pagina_type'),
                $m_pagina            = $('#m_pagina');
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                ...
                if (_adding) {
                    ...
                    /*Agregados*/
                    $m_category.val(_src.data('category'));
                    $m_pagina.val(_src.data('pagina'));
                    ...
                    if (_src.data('type')=="pagina") {
                        $m_link_type.val(' ').change();
                        $m_pagina.val(_src.data('url')).change();
                    }

                    if (_src.data('type')=="category") {
                        $m_link_type.val(' ').change();
                        $m_category.val(_src.data('url')).change();
                    }
            ...
            $m_link_type.on('change', function (e) {
                ...
                if ($m_link_type.val() == 'category') {
                    $m_url_type.hide();
                    $m_route_type.hide();
                    $m_pagina_type.hide();
                    $m_category_type.show();
                }else {
                    $m_category_type.hide();
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/saldeello.com/www/html/vendor/tcg/voyager/src/../resources/views/menus/builder.blade.php ENDPATH**/ ?>