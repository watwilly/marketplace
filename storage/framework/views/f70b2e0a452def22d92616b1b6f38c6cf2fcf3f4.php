                    ...
                    <table width="660" border="0" cellpadding="0" cellspacing="0" align="center">
                        <tr>
                            <td valign="middle" align="left">
                                <img src="https://<?php echo e($_SERVER['HTTP_HOST']); ?>/storage/<?php echo e(Voyager::setting('site.logo')); ?>" alt="<?php echo e(Voyager::setting('title')); ?>">
                            </td>
                        </tr>
                    </table>
                    <table width="660" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                        <tr>
                            <td valign="middle" style="padding: 20px 35px;">
                                ...
                                <p>Id de la publicacion: <?php echo e($post_id); ?></p>
                                <p>Id del usuario: <?php echo e($user_id); ?></p>
                                <p>Detalle del reporte: <?php echo e($detalle_reporte); ?></p>
...
</html><?php /**PATH /var/www/saldeello.com/www/html/resources/views/emails/reportes.blade.php ENDPATH**/ ?>