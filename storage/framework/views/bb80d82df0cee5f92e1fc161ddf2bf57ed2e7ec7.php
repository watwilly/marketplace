                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <select name="active" class="form-control">
                                    <option value="1" <?php if($dataTypeContent->active == 1): ?> selected <?php endif; ?>>ACTIVADO</option>
                                    <option value="0" <?php if($dataTypeContent->active == 0): ?> selected <?php endif; ?>>DESACTIVADO</option>
                                </select>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/saldeello.com/www/html/vendor/tcg/voyager/src/../resources/views/users/edit-add.blade.php ENDPATH**/ ?>