                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            <a href="/admin/users/<?php echo e($data->id); ?>/delete" title="Borrar" class="btn btn-sm btn-danger pull-right delete">
                                               <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Borrar</span>
                                            </a>
                                            <a href="/admin/users/<?php echo e($data->id); ?>/edit" title="Editar" class="btn btn-sm btn-primary pull-right edit">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/saldeello.com/www/html/vendor/tcg/voyager/src/../resources/views/users/browse.blade.php ENDPATH**/ ?>