...
<a href="#" id="back-to-top" class="btn btn-primary back-to-top"><i class="fas fa-angle-up"></i></a><?php /**PATH /var/www/html/web/saldeello/resources/views/layouts/footer.blade.php ENDPATH**/ ?>