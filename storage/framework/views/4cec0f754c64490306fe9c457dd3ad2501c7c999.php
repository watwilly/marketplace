            ...
            <section class="fs-5 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="mb-4">
                            Artículo: <a href="#" class="link-success"><?php echo e($post->title); ?></a>
                        </h6>
                        <h5 class="card-title"><?php echo e($mensaje); ?></h5>
                    </div>
                </div>
            </section>
            <section class="fs-5 text-center">
                <p>Ingresá a tu cuenta para responder esta consulta</p>
                <a href="https://<?php echo e($_SERVER['HTTP_HOST']); ?>/auth/user/login" class="btn btn-primary mb-3">Iniciar Sesión</a>
            </section>
        </div>
...
<?php /**PATH /var/www/saldeello.com/www/html/resources/views/emails/interesados.blade.php ENDPATH**/ ?>